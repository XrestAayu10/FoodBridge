...
assert.match(browse, /sessionStorage\.setItem\("aaharlink-selected-listing-id"/);
assert.match(detail, /queryListingId \|\| sessionStorage\.getItem\("aaharlink-selected-listing-id"\)/);
